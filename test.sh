...
ln -sf $scripts/tes.lst masterlist
...
**
'!echo "DATE,TIME(IST),WINDspd(m/s),WINDdir(degree),lev-Hgt,Power(KW)">'dat.csv
tt=$stme
hh=00
mi=00
...
'define lt=(((hgtprs)/637800)*673800)/(1-(hgtprs/637800)))'
'd lt'
rec4=sublin(result,1)
hgt=subwrd(rec4,4)
...
'!echo 'ti','hh':'mi','ws1','wdir','hgt','power' >>' dat.csv
tt=tt+1
mi=mi+15
p1=0
endwhile
